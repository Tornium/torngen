...
## 0.1.10 - 2026-27-03
### Added
- \[Elixir\] Added `moduledoc/0` to the `Torngen.Client.Path.*` template

### Fixed
- \[Python\] Fixed typing of the variadic path parameter in `BaseQuery.select`

## 0.1.9 - 2026-21-03
### Added
- \[Elixir\] Added `response_modules/0` to the `Torngen.Client.Path.*` template
...
## 0.1.7 - 2026-28-01
### Fixed
- \[Elixir\] Fixed validation in `allOf`
- \[Elixir\] Fixed parsing and validation of valid types in `oneOf`
